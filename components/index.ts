...
export { default as FAQ } from "./content/details";
...
export { default as Quote } from "./content/details";
...
export { default as Timer } from "./content/details";
...
export { default as DressCode } from "./content/details";
export { default as Itinerary } from "./content/details";
